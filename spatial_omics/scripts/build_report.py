...
from spatial_omics.config import ReportConfig, load_config
from spatial_omics.reporting.markdown import build_markdown_report


def main() -> int:
    parser = argparse.ArgumentParser(description="Build a Markdown report and plots from retained spatial-omics benchmark results.")
