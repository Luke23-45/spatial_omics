...
from spartial_omics.evaluation.positional_isolation import PositionalIsolationConfig, run_positional_isolation, save_positional_results


def main() -> int:
    parser = argparse.ArgumentParser(description="Run the isolated positional/spatial encoding study for Spectra.")
    ...
    parser.add_argument("--fourier-freqs", type=int, default=8)
    ...
    results = run_positional_isolation(cfg)
    save_positional_results(results, cfg.output_dir)
    return 0
