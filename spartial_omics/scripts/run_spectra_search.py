...
from spartial_omics.models.end_to_end_spectra import SpectraSearchConfig, run_spectra_search, save_spectra_search_results


def main() -> int:
    parser = argparse.ArgumentParser(description="Run end-to-end zero-feature Spectra architecture search.")
    ...
    parser.add_argument("--router-steps", type=int, default=4)
    parser.add_argument("--type-embedding-dim", type=int, default=20)
    parser.add_argument("--max-cells", type=int, default=160)
    parser.add_argument("--dropout", type=float, default=0.15)
    parser.add_argument("--spectral-components", type=int, default=6)
    ...
    results = run_spectra_search(cfg)
    save_spectra_search_results(results, cfg.output_dir)
    return 0
