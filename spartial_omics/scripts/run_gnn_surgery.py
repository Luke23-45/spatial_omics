...
from spartial_omics.models.gnn_spectra_surgery import GNNSurgeryConfig, run_gnn_surgery_study, save_gnn_surgery_results


def main() -> int:
    parser = argparse.ArgumentParser(description="Run GraphSAGE component surgery with Spectra-inspired internal modifications.")
    ...
    results = run_gnn_surgery_study(cfg)
    save_gnn_surgery_results(results, cfg.output_dir)
    return 0
