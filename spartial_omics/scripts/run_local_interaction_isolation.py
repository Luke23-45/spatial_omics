...
from spartial_omics.evaluation.local_interaction_isolation import (
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the isolated local-interaction study for Spectra.")
    ...
    results = run_local_interaction_isolation(cfg)
    save_local_interaction_results(results, cfg.output_dir)
    return 0
